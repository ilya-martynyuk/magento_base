...
class InstallSchema implements InstallSchemaInterface
{
    public function install(SchemaSetupInterface $setup, ModuleContextInterface $context)
    {
        ...
        $table = $setup
            ->getConnection()
            ->newTable($setup->getTable('imartynyuk_office_department'))
            ->addColumn(
                'entity_id',
            ...
            ->setComment('Imartynyuk Office Department Table');

        $setup
            ->getConnection()
            ->createTable($table);

        $employeeEntity = \Imartynyuk\Office\Model\Employee::ENTITY;
